            ...
            switch (resourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    ...
                    if (m_texturePrototypes[resourceIdx].m_LayerGUID != string.Empty)
                    {
                        ...
                        try
                        {
                            existingLayer = (TerrainLayer)AssetDatabase.LoadAssetAtPath(AssetDatabase.GUIDToAssetPath(m_texturePrototypes[resourceIdx].m_LayerGUID), typeof(TerrainLayer));
                        }
                        catch (Exception e)
                        {
