...
#region AutoSpawnerList
        ...
        private void DrawSaveAndLoad(bool helpEnabled)
        {
            ...
            m_selectedStampCategoryID = EditorGUILayout.IntPopup("Terrain Export Directory:", m_selectedStampCategoryID, m_stampCategoryNames.ToArray(), m_stampCategoryIDArray);
            EditorGUILayout.BeginHorizontal();
    ...
    //    }
        ...
        private void DrawAppearance(bool showHelp)
        {
            ...
            //if (m_stamper.m_cachedTerrain != null)
            //{
            //    maxSeaLevel = m_stamper.m_cachedTerrain.terrainData.size.y;
            //}
            //else
            //{
        ...
        private void DrawStampSettings(bool showHelp)
        {
            ...
            if (baseLevelEnabled)
            {
                m_stamper.m_settings.m_baseLevel = EditorGUILayout.Slider(GetLabel("Base Level"), m_stamper.m_settings.m_baseLevel, 0f, 1f);
                m_stamper.m_settings.m_drawStampBase = EditorGUILayout.Toggle(GetLabel("Stamp Base"), m_stamper.m_settings.m_drawStampBase);
                m_stamper.m_settings.m_adaptiveBase = EditorGUILayout.Toggle(GetLabel("Adaptive Base"), m_stamper.m_settings.m_adaptiveBase);
                m_stamper.m_showBase = EditorGUILayout.Toggle(GetLabel("Show Base"), m_stamper.m_showBase);
            }
        }
